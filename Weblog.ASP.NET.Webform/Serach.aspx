<%@ Page Title="" Language="C#" MasterPageFile="~/Master/NestedMasterPageSaidbarBlog.master" AutoEventWireup="true" CodeBehind="Serach.aspx.cs" Inherits="Weblog.ASP.NET.Webform.Serach" %>
<asp:Content ID="Content1" ContentPlaceHolderID="SubMasterContent" runat="server">
            ...
            <div class="col-md-8">
                ...
                <asp:LinqDataSource runat="server" ID="dsShowNews" OnSelecting="dsShowNews_Selecting"></asp:LinqDataSource>
                <asp:ListView runat="server" ID="lvShowNews" DataSourceID="dsShowNews">
                    ...
                    نوشته شده در دسته : <a href='<%# string.Format("/group/{0}/{1}",Eval("NewsGroupID"),Eval("TitleGroup")).Replace(" ","-").Replace("?","").Replace("؟","") %>' target="_blank">
                        ...
                        <a class="btn btn-primary" href='<%# string.Format("/post/{0}/{1}",Eval("NewsID"),Eval("NewsTitle")).Replace(" ","-").Replace("?","").Replace("؟","") %>' target="_blank">مشاهده کامل پست <span class="glyphicon glyphicon-chevron-right"></span></a>
                        <hr />
                    </ItemTemplate>
                </asp:ListView>
